...
function ChatIndexRoute() {
  ...
  return (
    <section className="flex h-full min-w-0 items-center justify-center overflow-hidden">
      <div className="w-full max-w-3xl px-10">
        <div className="rounded-[2rem] border border-border/70 bg-card/80 p-10 shadow-[0_24px_80px_rgba(0,0,0,0.24)] backdrop-blur">
          ...
          <p className="mt-4 max-w-2xl text-sm leading-7 text-muted-foreground">
            The old dashboard shell is gone. This surface is centered on the
            transcript, composer, diff review, and terminal flow.
          </p>
